...
// Варианты ответа
// 1. Неправильный синтаксис наследования класса [правильный ответ: нужно использовать extend]
// 2. Нужно наследоваться от ReactComponent, а не от React.ReactComponent
